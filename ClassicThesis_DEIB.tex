...
\begin{document}
	...
	% Frontmatter
	%*************************************************************
	% Uncomment the following line to add the ''copertina'' to the pdf (also adds a blank page)
	...
	% \cleardoublepage\include{FrontBackmatter/Publication} % i don't know if it's useful or not
	...
	%\setcounter{page}{90}
	% use \cleardoublepage here incase of problems with pdfbookmark
	\cleardoublepage
